...
{
    [TestClass] // Para que el test suite tome el assembly initialize... etc...
    public class LocalDbDatabaseInitializer
    {
        private static readonly string _dbName = "PruebasDeIntegracion";

        [AssemblyInitialize] // Se ejecuta al inicio de la ejecucion de pruebas
        ...
        [AssemblyCleanup] // Se ejecuta al finalizar, para borrar la db
